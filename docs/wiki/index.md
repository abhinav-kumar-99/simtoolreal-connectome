...
- [Billion-step adaptation run](analyses/adaptation-1b-run.md) — Matched adapters-only and neuron-gains jobs, one single-GPU policy per device. Last updated 2026-09-13.
