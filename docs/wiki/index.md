...
- [Adaptation and custom compute](concepts/connectome-adaptation.md) — Legacy adaptation modes plus unified latent intrinsic/efficacy/topology plasticity, information control, spectral geometry, monitoring, and GPU backends. Last updated 2026-09-22.
