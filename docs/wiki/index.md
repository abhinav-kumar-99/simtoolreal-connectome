...
- [Experiment workflow](workflows/connectome-experiments.md) — Four-update Beta training, milestone videos, LF entropy runs, and the staged 1G success handoff. Last updated 2026-09-15.
