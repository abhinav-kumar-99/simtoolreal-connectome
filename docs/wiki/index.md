...
- [Dopamine-inspired online learning](analyses/dopamine-inspired-learning.md) — Biological evidence, warm-start and from-scratch eligibility proposals, credit-assignment requirements and measured cost limits; not implemented. Last updated 2026-09-13.
