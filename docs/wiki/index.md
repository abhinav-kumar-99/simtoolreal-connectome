...
- [Minimal dexterity circuits](analyses/minimal-dexterity-circuit.md) — Cross-system comparison, exact 86/262/408-cell candidates, five-contact rationale and 262-vs-current resource estimates; no candidate training or minimum-size validation. Last updated 2026-09-14.
