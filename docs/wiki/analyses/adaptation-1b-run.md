...
The exploratory jobs were stopped by request after logged frames 139,788,288 for adapters-only and 144,113,664 for neuron-gains. Their latest saved checkpoints are epoch/frame 692/136,052,736 and 734/144,310,272, respectively; evaluation uses checkpoint metadata rather than the later unsaved log position.
